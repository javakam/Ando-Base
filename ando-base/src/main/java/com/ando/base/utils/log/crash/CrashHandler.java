package com.ando.base.utils.log.crash;
...
import com.ando.base.core.Library;
import com.ando.base.utils.FileUtils;
import com.ando.base.utils.TimeUtils;
import com.ando.base.utils.log.Logger;
 ...
 * Title:CrashHandler
 * <p>
 * Description: todo 2019-11-15 14:39:20 整合万门修改过的 CrashHandler
 * </p>
 *
 * @author Changbao
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private static void initCrashHandler(Context context, boolean isDebug, String toastMsg,
        ...
        crashHandler.filePath = FileUtils.getCachePath(context, Config.CRASH);
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            Logger.e(TAG, "an error occurred while writing file...", e);
        } finally {
            if (null != os) {
                try {
                    os.close();
