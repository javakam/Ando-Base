...
import com.ando.views.sample.addresspicker.bean.CityBean;
import com.ando.views.sample.addresspicker.dao.AddressDao;
...
//* {"id":22,"code":"","label":"天津","value":"120000","priority":null,"mark":"","pid":3},{"
    ...
    private class AddressPickerAdapter
        ...
        @Override
        public AddressSelectHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
            return new AddressSelectHolder(
