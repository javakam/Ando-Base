...
import com.ando.views.spinner.CommonSpinner;
import com.ando.views.spinner.MultiChoiceSpinner;
import com.ando.views.spinner.OnItemEditListener;
import com.ando.views.spinner.SingleChoiceSpinner;
...
public class SpinnerActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //年份选择
        int curYearNum = getYearForSystem();
        int length = 5;
        years.add(TEXT_ALL);
