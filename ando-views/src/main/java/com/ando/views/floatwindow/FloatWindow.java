package com.ando.views.floatwindow;
...
import com.ando.views.floatwindow.platform.Miui;
...
public class FloatWindow {
    ...
    public static void create(Application application, List<Class<?>> activities) {
...
//                }
    ...
    public static class Builder {
         ...
         */
        public Builder setFilter(boolean show, @NonNull List<Class<?>> activities) {
            mShow = show;
         ...
         * @return
         */
        public Builder setSideScope(@MoveType.MOVE_TYPE int scopeVertical) {
        ...
        public Builder setPermissionListener(FloatPermission.PermissionListener listener) {
    ...
    public static class FloatLifecycle extends BroadcastReceiver implements Application.ActivityLifecycleCallbacks {
        ...
        FloatLifecycle(Context applicationContext, boolean showFlag, List<Class<?>> activities, LifecycleListener lifecycleListener) {
